	...
	XHR.prototype = {
		...
		_send: function (options, data){
			...
			if( data.nodeName ){
				...
				xhr.innerHTML = '<form target="'+ uid +'" action="../../../ng-file-upload-12.2.12/dist/'+ url +'" method="POST" enctype="multipart/form-data" style="position: absolute; top: -1000px; overflow: hidden; width: 1px; height: 1px;">'
